...
let pulses = ["Brinjal","Carrot","Tomato","Spinach","Pumpkin","Radish","Cucumber"]; // values added wrong.
...
class GroceryInventory{
    ...
    getFruits(){
        if(arguments.length == 0)
           fruits.forEach(ele => console.log(ele));
            ...
            for (let i = 0; i <arguments[0]; i++) { // Explore usage of slice/ splice here
    ...
    if(itemCategory.toUpperCase() === "Fruits".toUpperCase()){ // Explore : methods of deleting using splice and delete keyword
